...
public class WebClientConfig {
    ...
    public WebClient webClientAutenticacion(WebClient.Builder builder) {
        ...
        HttpClient httpClient = HttpClient.create()
                .option(ChannelOption.CONNECT_TIMEOUT_MILLIS, 11000) // timeout de conexion
                .responseTimeout(Duration.ofSeconds(11)) // timeout de lectura de toda la respuesta
                .doOnConnected(conn -> conn.addHandlerLast(new ReadTimeoutHandler(11, TimeUnit.SECONDS)));
        return builder
    ...
    public WebClient webClientFinanzas(WebClient.Builder builder) {
        ...
        HttpClient httpClient = HttpClient.create()
                .option(ChannelOption.CONNECT_TIMEOUT_MILLIS, 11000)
